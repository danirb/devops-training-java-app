...
Repositorio de la aplicacion Java usada en el curso para practicar estrategias DevOps de CI/CD en proyectos compilados.
...
- App Java simple con empaquetado y ejecucion en contenedor.
- Base para pipelines, tests y analisis de calidad en CI/CD.
